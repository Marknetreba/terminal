...
select fil.webname, sh.SCHEDID,sh.CASHID,sh.filial,doc.dcode,ch.CHID,doc.fullname as docname,ch.chname,sh.pcode,sh.BHOUR,sh.bmin,sh.fHOUR,sh.fmin, cl.fullname,cl.bdate, sh.visit_uid, sh.visittime, sh.clvisit from SCHEDULE sh
...
where ws.speccode = 130 and '31.05.2018' between cls.sdate and cls.fdate) on (sh.pcode = patr)
where sh.workdate = '31.05.2018' and sh.FILIAL='55'